...
# ignore whitespace and lines moved or copied in same commit
export alias gbl = git blame -b -w -C 
# ignore whitespace, lines moved or copied in same commit
# or commit that created file
# or any file
export alias gblc = git blame -b -w -C -C -C
