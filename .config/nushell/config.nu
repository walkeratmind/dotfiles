...
def create_right_prompt [] {
    let time_segment = ([
        (date now | date format '%r') # add date %m/%d/%Y
    ] | str collect)
...
let-env PROMPT_COMMAND = { STARSHIP_SHELL=nushell starship prompt ;
#      zoxide init nushell --hook prompt | save ~/config/zoxide/.zoxide.nu; source ~/.config/zoxide/.zoxide.nu;
}
