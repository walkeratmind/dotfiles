# Generated by Powerlevel10k configuration wizard on 2020-04-07 at 19:51 +0545.
...
# blurred tails, 2 lines, disconnected, right frame, dark-ornaments, sparse, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_JAVA_VERSION_BACKGROUND=5
  ...
  typeset -g POWERLEVEL9K_FVM_BACKGROUND=38
  # Custom icon.
